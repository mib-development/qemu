...
#define PWRGATE_STATUS_RESET  0xFFFFFFFF
typedef union pwrgate_status_u {
    struct {
        ...
        unsigned int heg:1;                 /* status of HEG partition; 0 = OFF; 1 = ON */
        unsigned int sax:1;                 /* status of SAX partition; 0 = OFF; 1 = ON */
        unsigned int ce1:1;                 /* status of CE1 partition; 0 = OFF; 1 = ON */
        unsigned int ce2:1;                 /* status of CE2 partition; 0 = OFF; 1 = ON */
        unsigned int ce3:1;                 /* status of CE3 partition; 0 = OFF; 1 = ON */
        unsigned int a9lp:1;                /* status of A9LP partition; 0 = OFF; 1 = ON */
        unsigned int td2:1;                 /* status of TD2 partition; 0 = OFF; 1 = ON */
