...
typedef union gpio_cnf_u {
    struct {
        ...
        unsigned int lock_0:1;              /* Lock access to pin 0 CNF, OE and OUT; 0 = DISABLE; 1 = ENABLE */
        unsigned int lock_1:1;              /* Lock access to pin 1 CNF, OE and OUT; 0 = DISABLE; 1 = ENABLE */
        unsigned int lock_2:1;              /* Lock access to pin 2 CNF, OE and OUT; 0 = DISABLE; 1 = ENABLE */
        unsigned int lock_3:1;              /* Lock access to pin 3 CNF, OE and OUT; 0 = DISABLE; 1 = ENABLE */
        unsigned int lock_4:1;              /* Lock access to pin 4 CNF, OE and OUT; 0 = DISABLE; 1 = ENABLE */
        unsigned int lock_5:1;              /* Lock access to pin 5 CNF, OE and OUT; 0 = DISABLE; 1 = ENABLE */
        unsigned int lock_6:1;              /* Lock access to pin 6 CNF, OE and OUT; 0 = DISABLE; 1 = ENABLE */
        unsigned int lock_7:1;              /* Lock access to pin 7 CNF, OE and OUT; 0 = DISABLE; 1 = ENABLE */
...
#define GPIO_MSK_CNF_OFFSET 0x80
...
#define GPIO_MSK_OE_OFFSET 0x90
...
#define GPIO_MSK_OUT_OFFSET 0xA0
...
#define GPIO_MSK_INT_STA_OFFSET 0xC0
...
#define GPIO_MSK_INT_ENB_OFFSET 0xD0
...
#define GPIO_MSK_INT_LVL_OFFSET 0xE0
...
#define GPIO_LOCK_OFFSET 0xF0
#define GPIO_LOCK_RESET  0x00000000
typedef union gpio_lock_u {
    struct {
        unsigned int bit_0:1;               /* Lock access to each pin; 0 = DISABLE; 1 = ENABLE */
        unsigned int bit_1:1;               /* Lock access to each pin; 0 = DISABLE; 1 = ENABLE */
        unsigned int bit_2:1;               /* Lock access to each pin; 0 = DISABLE; 1 = ENABLE */
        unsigned int bit_3:1;               /* Lock access to each pin; 0 = DISABLE; 1 = ENABLE */
        unsigned int bit_4:1;               /* Lock access to each pin; 0 = DISABLE; 1 = ENABLE */
        unsigned int bit_5:1;               /* Lock access to each pin; 0 = DISABLE; 1 = ENABLE */
        unsigned int bit_6:1;               /* Lock access to each pin; 0 = DISABLE; 1 = ENABLE */
        unsigned int bit_7:1;               /* Lock access to each pin; 0 = DISABLE; 1 = ENABLE */
        unsigned int undefined_bits_8_31:24;
    };
