...
typedef union csr_u {
    struct {
        ...
        unsigned int switch_cluster:1;
        unsigned int immediate_wake:1;
...
typedef union cluster_control_u {
    struct {
        unsigned int active:1;             /* 0 = G 1 = LP */
        unsigned int undefined_bits_1_7:7;
        unsigned int pre_switch_delay:12;
        unsigned int post_switch_delay:12;
    };
