...
#define TYPE_TEGRA_BSE_DUMMY_768B "tegra.dummy768"
#define TEGRA_DUMMY(obj) OBJECT_CHECK(tegra_dummy, (obj), TYPE_TEGRA_BSE_DUMMY_768B)
...
static const TypeInfo tegra_dummy_info = {
    .name = TYPE_TEGRA_BSE_DUMMY_768B,
