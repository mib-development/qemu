...
#define INT_QUIN_RES_0			(INT_QUIN_BASE + 0)
#define INT_QUIN_RES_1			(INT_QUIN_BASE + 1)
#define INT_QUIN_RES_2			(INT_QUIN_BASE + 2)
#define INT_QUIN_RES_3			(INT_QUIN_BASE + 3)
#define INT_QUIN_RES_4			(INT_QUIN_BASE + 4)
#define INT_QUIN_RES_5			(INT_QUIN_BASE + 5)
#define INT_QUIN_RES_6			(INT_QUIN_BASE + 6)
#define INT_QUIN_RES_7			(INT_QUIN_BASE + 7)
#define INT_QUIN_RES_8			(INT_QUIN_BASE + 8)
#define INT_QUIN_RES_9			(INT_QUIN_BASE + 9)
#define INT_QUIN_RES_10			(INT_QUIN_BASE + 10)
#define INT_QUIN_RES_11			(INT_QUIN_BASE + 11)
#define INT_QUIN_RES_12			(INT_QUIN_BASE + 12)
#define INT_QUIN_RES_13			(INT_QUIN_BASE + 13)
#define INT_QUIN_RES_14			(INT_QUIN_BASE + 14)
#define INT_QUIN_RES_15			(INT_QUIN_BASE + 15)
#define INT_QUIN_RES_16			(INT_QUIN_BASE + 16)
#define INT_QUIN_RES_17			(INT_QUIN_BASE + 17)
#define INT_QUIN_RES_18			(INT_QUIN_BASE + 18)
#define INT_QUIN_RES_19			(INT_QUIN_BASE + 19)
...
#define INT_GIC_NR			(INT_QUAD_BASE + 32 + INT_CPU_IRQS_NR)
