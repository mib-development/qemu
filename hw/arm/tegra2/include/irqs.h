...
#define INT_SDMMC4			(INT_PRI_BASE + 22) // check me
...
#define INT_SDMMC5			(INT_PRI_BASE + 31) // check me
...
#define INT_SBC6			(INT_TRI_BASE + 15)
...
#define INT_PCIE_WAKE			(INT_QUAD_BASE + 4)
...
#define INT_QUIN_BASE			(INT_QUAD_BASE + 32)
#define INT_APB_DMA_CH16			(INT_QUIN_BASE + 0)
#define INT_APB_DMA_CH17			(INT_QUIN_BASE + 1)
#define INT_APB_DMA_CH18			(INT_QUIN_BASE + 2)
#define INT_APB_DMA_CH19			(INT_QUIN_BASE + 3)
#define INT_APB_DMA_CH20			(INT_QUIN_BASE + 4)
#define INT_APB_DMA_CH21			(INT_QUIN_BASE + 5)
#define INT_APB_DMA_CH22			(INT_QUIN_BASE + 6)
#define INT_APB_DMA_CH23			(INT_QUIN_BASE + 7)
#define INT_APB_DMA_CH24			(INT_QUIN_BASE + 8)
#define INT_APB_DMA_CH25			(INT_QUIN_BASE + 9)
#define INT_APB_DMA_CH26			(INT_QUIN_BASE + 10)
#define INT_APB_DMA_CH27			(INT_QUIN_BASE + 11)
#define INT_APB_DMA_CH28			(INT_QUIN_BASE + 12)
#define INT_APB_DMA_CH29			(INT_QUIN_BASE + 13)
#define INT_APB_DMA_CH30			(INT_QUIN_BASE + 14)
#define INT_APB_DMA_CH31			(INT_QUIN_BASE + 15)
#define INT_CPU0_PMU_INTR			(INT_QUIN_BASE + 16)
#define INT_CPU1_PMU_INTR			(INT_QUIN_BASE + 17)
#define INT_CPU2_PMU_INTR			(INT_QUIN_BASE + 18)
#define INT_CPU3_PMU_INTR			(INT_QUIN_BASE + 19)
#define INT_QUIN_RES_20			(INT_QUIN_BASE + 20)
#define INT_QUIN_RES_21			(INT_QUIN_BASE + 21)
#define INT_QUIN_RES_22			(INT_QUIN_BASE + 22)
#define INT_QUIN_RES_23			(INT_QUIN_BASE + 23)
#define INT_QUIN_RES_24			(INT_QUIN_BASE + 24)
#define INT_QUIN_RES_25			(INT_QUIN_BASE + 25)
#define INT_QUIN_RES_26			(INT_QUIN_BASE + 26)
#define INT_QUIN_RES_27			(INT_QUIN_BASE + 27)
#define INT_QUIN_RES_28			(INT_QUIN_BASE + 28)
#define INT_QUIN_RES_29			(INT_QUIN_BASE + 29)
#define INT_QUIN_RES_30			(INT_QUIN_BASE + 30)
#define INT_QUIN_RES_31			(INT_QUIN_BASE + 31)

#define INT_GIC_NR			(INT_QUIN_BASE + 32 + INT_CPU_IRQS_NR)

#define INT_MAIN_NR			(INT_GIC_NR - INT_CPU_IRQS_NR)

#define INT_SYNCPT_THRESH_BASE		(INT_QUIN_BASE + 32)
